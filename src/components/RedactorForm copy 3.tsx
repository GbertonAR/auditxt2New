...
export function RedactorForm() {
  ...
  const [categoriaTono, setCategoriaTono] = useState("institucional"); // CAMBIO
  const [subtono, setSubtono] = useState(""); // CAMBIO
  ...
  return (
    ...
    >
      ...
      {/* Botón mejorado y animación */}
      <div className="space-y-2">
        <Button
          type="submit"
          disabled={loading || !prompt.trim()}
          aria-busy={loading}
          className="w-full bg-blue-600 hover:bg-blue-700 text-blue font-semibold"
        >
